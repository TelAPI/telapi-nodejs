...
/**
 * Gather glass. Represents an InboundXML <Gather> element.
...
/**
 * GetSpeech glass. Represents an InboundXML <Gather> element.
 * See: http://www.telapi.com/docs/api/inboundxml/voice/gather/
 *
 * @param {Mixed} body: (Optional) Either a Play, Say, or Pause element.
 * @param {Map} attrs: (Optional) Attributes for this XML element.
 *
 */
var GetSpeech = module.exports.Gather = function GetSpeech(body, attrs) {
    var self = this;
